...
public class validateamountfunctionality {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        // Fetch price of product 1
        String amount1 = driver.findElements(By.id("com.androidsample.generalstore:id/productPrice")).get(0).getText();
        amount1 = amount1.substring(1); // remove $
        double amount1value = Double.parseDouble(amount1);

        // Fetch price of product 2
        String amount2 = driver.findElements(By.id("com.androidsample.generalstore:id/productPrice")).get(1).getText();
        amount2 = amount2.substring(1); // remove $
        ...
        // Get total amount displayed on cart screen
        String total = driver.findElement(By.id("com.androidsample.generalstore:id/totalAmountLbl")).getText();
        total = total.substring(1); // remove $
