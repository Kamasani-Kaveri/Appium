...
public class UICatalogappDropdownFunction {
    public static void main(String[] args) throws MalformedURLException {
        ...
        driver.findElement(By.xpath("//*[@name=\"Picker View\"]")).click();
        driver.findElement(By.name("Green color component value")).sendKeys("220");
        List<WebElement> pickerWheels = driver.findElements(By.className("XCUIElementTypePickerWheel"));
        pickerWheels.get(0).sendKeys("55");
